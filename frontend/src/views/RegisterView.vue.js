...
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
    ...
    required: (true),
    ...{ class: ("appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[#FF9234] focus:border-[#FF9234]") },
    ...{ class: (({ 'border-red-500': __VLS_ctx.errors.firstName })) },
});
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
    ...
    required: (true),
    ...{ class: ("appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[#FF9234] focus:border-[#FF9234]") },
    ...{ class: (({ 'border-red-500': __VLS_ctx.errors.lastName })) },
});
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    ...{ onClick: (__VLS_ctx.handleFacebookRegister) },
    type: ("button"),
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    ...{ onClick: (__VLS_ctx.handleGoogleRegister) },
    type: ("button"),
